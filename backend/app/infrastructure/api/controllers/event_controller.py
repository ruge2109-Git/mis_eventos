...
class EventController:
    ...
    def create_event(self, title: str, capacity: int, start_date: datetime, end_date: datetime, organizer_id: int, location: Optional[str], description: Optional[str]):
    ...
    def list_events(self, skip: int, limit: int, search: Optional[str]):
